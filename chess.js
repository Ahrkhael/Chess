...
class King {
  ...
  isLegalMove(square, squareOrigin) {
    ...
    const diffX =
      Number(square.dataset.column) - Number(squareOrigin.dataset.column);
...
function canCastle(king, tower) {
  ...
  if (squaresBetween.length === 2) {
    for (let square of squaresBetween) {
      if (
        square.querySelector(".pieces") ||
        enemyPossibleMoves.some((move) => move.to === square)
      ) {
        return false;
      }
    }
    ...
    if (
      enemyPossibleMoves.some((move) => move.to === squaresBetween[1]) ||
      enemyPossibleMoves.some((move) => move.to === squaresBetween[2])
    ) {
      return false;
    }
  }
...
class Queen {
  ...
  isLegalMove(square, squareOrigin) {
    if (square !== squareOrigin && !squareHasOwnPiece(square, this.player)) {
      let squareOriginNumber =
        Number(squareOrigin.dataset.column) -
        1 +
        8 * (8 - Number(squareOrigin.dataset.row));
      ...
      if (square.dataset.row === squareOrigin.dataset.row) {
          ...
          for (let i = 1; i < Math.abs(diffX); i++) {
            if (
              document
                ...
                [squareOriginNumber - i].querySelector(".pieces")
            ) {
              return false;
            }
          }
        ...
        let diffY =
          Number(squareOrigin.dataset.row) - Number(square.dataset.row);
        if (diffY < 0) {
          for (let i = 1; i < Math.abs(diffY); i++) {
            if (
              document
                .getElementsByClassName("square")
                [squareOriginNumber - 8 * i].querySelector(".pieces")
            ) {
              return false;
            }
          }
        ...
        if (diffX < 0 && diffY < 0) {
          for (let i = 1; i < Math.abs(diffX); i++) {
            if (
              document
                .getElementsByClassName("square")
                [squareOriginNumber - 9 * i].querySelector(".pieces")
            ) {
              return false;
            }
          }
          ...
          for (let i = 1; i < diffX; i++) {
            if (
              document
                .getElementsByClassName("square")
                [squareOriginNumber - 7 * i].querySelector(".pieces")
            ) {
              return false;
            }
          }
  ...
  isLegalMove(square, squareOrigin) {
    if (square !== squareOrigin && !squareHasOwnPiece(square, this.player)) {
      if (squareOrigin.dataset.column === square.dataset.column) {
        if (this.player === "White") {
          if (!square.querySelector(".pieces")) {
            if (square.dataset.row == Number(squareOrigin.dataset.row) + 1) {
              ...
              squareOrigin.dataset.row == 2 &&
              square.dataset.row == 4
            ) {
              if (
                !document
                  .getElementsByClassName("square")
                  [Number(square.dataset.column) + 39].querySelector(".pieces")
              ) {
                return true;
              }
            }
          ...
          if (!square.querySelector(".pieces")) {
            if (square.dataset.row == Number(squareOrigin.dataset.row) - 1) {
              ...
              squareOrigin.dataset.row == 7 &&
              square.dataset.row == 5
            ) {
              if (
                !document
                  .getElementsByClassName("square")
                  [Number(square.dataset.column) + 15].querySelector(".pieces")
              ) {
                return true;
              }
            }
        ...
        squareOrigin.dataset.column == Number(square.dataset.column) + 1 ||
        squareOrigin.dataset.column == Number(square.dataset.column) - 1
      ) {
        if (square.querySelector(".pieces")) {
          if (this.player === "White") {
            if (
              square.querySelector(".pieces").dataset.player === "Black" &&
            ...
            if (
              square.querySelector(".pieces").dataset.player === "White" &&
              square.dataset.row == Number(squareOrigin.dataset.row) - 1
            ) {
              return true;
            }
...
class Knight {
  ...
  isLegalMove(square, squareOrigin) {
    if (square !== squareOrigin && !squareHasOwnPiece(square, this.player)) {
      if (
        square.dataset.row == Number(squareOrigin.dataset.row) + 2 &&
        square.dataset.column == Number(squareOrigin.dataset.column) - 1
      ) {
        return true;
      } else if (
        square.dataset.row == Number(squareOrigin.dataset.row) + 2 &&
        ...
        square.dataset.row == Number(squareOrigin.dataset.row) + 1 &&
        square.dataset.column == Number(squareOrigin.dataset.column) - 2
      ) {
        return true;
      } else if (
        square.dataset.row == Number(squareOrigin.dataset.row) + 1 &&
...
function handleSquareClick(event) {
  ...
  if (getAllLegalMoves(playerActive).length === 0) {
    showModalGameEnded();
  }
}
...
function showModalDrawOffering() {
  ...
  textToShow.innerHTML = `¿El jugador de ${translateColor(
    getOpponentColor(playerActive)
  ).toLowerCase()} acepta las tablas?`;
...
function selectPiece(square) {
  ...
  const possibleMovesPieceSelected = getAllPossibleMovesSquare(
    playerActive,
    square
  );
...
function movePiece(square) {
  ...
  if (pieceOrigin.isLegalMove(square, squareOrigin)) {
    if (!square.querySelector(".pieces")) {
      ...
      square.querySelector(".pieces").dataset.player !==
      pieceSelected.dataset.player
    ) {
    ...
    if (canCastle(whiteKing, whiteTower2)) {
      ...
      square.appendChild(pieceSelected);
      document
        .getElementsByClassName("square")[61]
        .appendChild(
    ...
    if (canCastle(whiteKing, whiteTower1)) {
      ...
      square.appendChild(pieceSelected);
      document
        .getElementsByClassName("square")[59]
        .appendChild(
    ...
    if (canCastle(blackKing, blackTower2)) {
      ...
      square.appendChild(pieceSelected);
      document
        .getElementsByClassName("square")[5]
        .appendChild(
    ...
    if (canCastle(blackKing, blackTower1)) {
      ...
      square.appendChild(pieceSelected);
      document
        .getElementsByClassName("square")[3]
        .appendChild(
  ...
  if (getChessPiece(square) === whiteKing) {
    if (canCastle(whiteKing, whiteTower1)) {
      filteredMoves.push({
        whiteKing,
        from: square,
        to: document.getElementsByClassName("square")[58],
      });
    }
    if (canCastle(whiteKing, whiteTower2)) {
      filteredMoves.push({
        whiteKing,
        from: square,
        to: document.getElementsByClassName("square")[62],
      });
    }
    ...
    if (canCastle(blackKing, blackTower1)) {
      filteredMoves.push({
        whiteKing,
        from: square,
        to: document.getElementsByClassName("square")[2],
      });
    }
    if (canCastle(blackKing, blackTower2)) {
      filteredMoves.push({
        whiteKing,
        from: square,
        to: document.getElementsByClassName("square")[6],
      });
    }
  }
